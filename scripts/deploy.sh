...
# The chart calculation now runs in-process; stop the retired Python worker if
# it survives from an earlier release.
pm2 delete vedic-service 2>/dev/null || true
