export default defineNitroPlugin((nitroApp) => {
  nitroApp.hooks.hook('llms:generate', (event, options) => {
    ...
    const routeDescriptions: Record<string, { title: string; description: string; category: string }> = {
      ...
      '/fortune-telling/horoscope': { title: 'Daily Horoscope Hub', description: 'Deterministic daily horoscopes for all 12 zodiac signs with love, work, wealth, health, lucky number, lucky color, moon sign, phase and planetary aspects, plus calendar subscriptions and AI interpretation', category: 'tools' },
      ...
      '/tools/thai-astro-paipan': { title: 'Thai 12 Rasi Chart', description: 'Generate a Thai astrology birth chart with 12 Rasi, 12 houses, Lagna, nine luminaries, Thai Ketu, Tanuseth, Taksa, Triyanga, Navamsa and Panchang references', category: 'tools' },
      ...
      '/tools/natal-astro': { title: 'Western Natal Astrology Chart', description: 'Generate a complete tropical natal chart with planets, Chiron, asteroids, lunar nodes, Lilith, lots, four angles, Placidus houses, aspects, patterns, dignities and distribution analysis', category: 'tools' },
      ...
      '/tools/sukuyo-paipan': { title: 'Sukuyo Astrology Chart', description: 'Calculate a 27-mansion Sukuyo chart with true solar time, sidereal Moon, Nakshatra pada, civil-lunar comparison, Four Symbols, seven-mansion groups, relations and boundary checks', category: 'tools' },
      '/tools/rokusei-senjutsu': { title: 'Rokusei Senjutsu', description: 'Calculate Six-Star Astrology destiny types, polarity, Reigo conditions, annual, monthly and daily cycles, and Bazi decade fate-kill windows', category: 'tools' },
      ...
      '/tools/guandi-lot': { title: 'Guandi Oracle', description: 'Traditional 100-sign Guandi oracle stick divination. Enter your question, draw a classical sign with sacred intent and classical notes, and receive an AI interpretation', category: 'tools' },
      '/tools/wong-tai-sin-lot': { title: 'Wong Tai Sin Oracle', description: 'Traditional 100-sign Wong Tai Sin oracle stick divination with poems, allusions, interpretations and AI guidance', category: 'tools' },
      '/tools/wenshu-lot': { title: 'Manjushri Oracle', description: 'Traditional 100-sign Manjushri oracle stick divination for study, wisdom, career and general questions. Draw a sign with poem, sacred meaning and AI guidance', category: 'tools' },
      '/tools/dizang-lot': { title: 'Dizang Oracle', description: 'Traditional 60-sign Dizang oracle stick divination with Ganzhi titles, poems, notes, interpretations and AI guidance', category: 'tools' },
      '/tools/tudigong-lot': { title: 'Tudigong Oracle', description: 'Traditional 32-sign Tudigong oracle stick divination with ranks, poems, classical judgments, immortal notes and AI guidance', category: 'tools' },
      '/tools/baosheng-lot': { title: 'Baosheng Dadi Oracle', description: 'Traditional 60-sign Baosheng Dadi oracle stick divination with poems, category judgments and AI guidance', category: 'tools' },
      ...
      '/tools/thai-tarot': { title: 'Thai Tarot Reading', description: 'Draw from the full 78-card Thai-language Rider-Waite-Smith tarot with Thai names, upright and reversed meanings, spreads, structured evidence, and AI interpretation', category: 'tools' },
