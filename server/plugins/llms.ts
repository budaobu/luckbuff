export default defineNitroPlugin((nitroApp) => {
  nitroApp.hooks.hook('llms:generate', (event, options) => {
    ...
    const routeDescriptions: Record<string, { title: string; description: string; category: string }> = {
      ...
      '/tools/xuankong-feixing': { title: 'Xuan Kong Flying Star Chart', description: 'Generate a complete Xuan Kong Flying Star chart with compass orientation, period stars, mountain and water charts, lower-gua or substitution methods, classical patterns and annual overlays', category: 'tools' },
