    ...
    <div class="bzr-sheet">
      ...
      <header class="bzr-head">
        <div class="bzr-head-top">
          <div class="bzr-brand">
            <div class="bzr-seal">{{ $t('baziHunpan.report.seal') }}</div>
            <span class="bzr-brand-name">{{ $t('baziHunpan.report.brandName') }}</span>
          </div>
          <div class="bzr-head-right">
            <span class="bzr-time">{{ $t('baziHunpan.report.generatedAt') }}：{{ generatedAt }}</span>
            <span class="bzr-rating">{{ $t('baziHunpan.report.rating') }}</span>
      ...
      <section class="bzr-section">
        <div class="bzr-card bzr-overview">
          <div class="bzr-overview-label">{{ $t('baziHunpan.report.overviewLabel') }}</div>
      ...
      <section class="bzr-row bzr-row-top">
        ...
        <div class="bzr-card bzr-profile">
          ...
          <div class="bzr-profile-line">
            ...
            <span class="bzr-profile-label">{{ $t('baziHunpan.report.genderLabel') }}</span>
            <span class="bzr-profile-value">{{ genderTextA }}</span>
          </div>
          <div class="bzr-profile-line">
            <span class="bzr-ico">☀</span>
            <span class="bzr-profile-label">{{ $t('baziHunpan.report.rizhuLabel') }}</span>
            <span class="bzr-profile-value">{{ chartA.riZhu }}（{{ chartA.riZhuStrength }}）</span>
          </div>
          <div class="bzr-profile-line">
            <span class="bzr-ico">❖</span>
            <span class="bzr-profile-label">{{ $t('baziHunpan.report.gejuLabel') }}</span>
            <span class="bzr-profile-value">{{ chartA.geju }}</span>
          </div>
          <div class="bzr-profile-line">
            <span class="bzr-ico">✦</span>
            <span class="bzr-profile-label">{{ $t('baziHunpan.report.xiyongLabel') }}</span>
            <span class="bzr-profile-value">{{ chartA.xiyong || '—' }}</span>
          </div>
        </div>
        ...
        <div class="bzr-card bzr-profile">
          ...
          <div class="bzr-profile-line">
            <span class="bzr-ico">☀</span>
            <span class="bzr-profile-label">{{ $t('baziHunpan.report.rizhuLabel') }}</span>
            <span class="bzr-profile-value">{{ chartB.riZhu }}（{{ chartB.riZhuStrength }}）</span>
          </div>
          <div class="bzr-profile-line">
            <span class="bzr-ico">❖</span>
            <span class="bzr-profile-label">{{ $t('baziHunpan.report.gejuLabel') }}</span>
            <span class="bzr-profile-value">{{ chartB.geju }}</span>
          </div>
          <div class="bzr-profile-line">
            <span class="bzr-ico">✦</span>
            <span class="bzr-profile-label">{{ $t('baziHunpan.report.xiyongLabel') }}</span>
            <span class="bzr-profile-value">{{ chartB.xiyong || '—' }}</span>
          </div>
        </div>

        <!-- 五行互补分组柱状图 -->
        <div class="bzr-card bzr-wuxing-card">
          <h3 class="bzr-card-title">{{ $t('baziHunpan.report.wuxingCompareTitle') }}</h3>
          <div class="bzr-wuxing-compare">
            <div v-for="w in wuxingCompare" :key="w.name" class="bzr-wuxing-group">
              <div class="bzr-wuxing-bars">
                <span
                  class="bzr-wuxing-bar bzr-wuxing-bar-a"
                  :style="{ height: w.a + '%', background: w.color }"
                  :title="`${displayNameA} ${w.a}%`"
                />
                <span
                  class="bzr-wuxing-bar bzr-wuxing-bar-b"
                  :style="{ height: w.b + '%', background: w.color }"
                  :title="`${displayNameB} ${w.b}%`"
                />
              </div>
              <div class="bzr-wuxing-group-name">{{ w.name }}</div>
            </div>
          </div>
      ...
      <!-- ============ 缘分匹配指数 ============ -->
      <section class="bzr-section">
        <h3 class="bzr-section-title">{{ $t('baziHunpan.report.matchTitle') }}</h3>
        <div class="bzr-match-grid">
          <!-- 综合指数仪表盘 -->
          <div class="bzr-card bzr-match-score-card">
            <div class="bzr-match-score-label">{{ $t('baziHunpan.report.matchScoreLabel') }}</div>
      ...
      <!-- ============ 核心数据 ============ -->
      <section class="bzr-section">
        <h3 class="bzr-section-title">{{ $t('baziHunpan.report.coreDataTitle') }}</h3>
        <div class="bzr-core-grid">
          <div class="bzr-card bzr-core">
            <div class="bzr-core-label">{{ $t('baziHunpan.report.rizhuLabel') }} · {{ displayNameA }}</div>
            <div class="bzr-core-value">{{ chartA.riZhu }}</div>
            <div class="bzr-core-sub">{{ chartA.riZhuStrength }}</div>
          </div>
          <div class="bzr-card bzr-core">
            <div class="bzr-core-label">{{ $t('baziHunpan.report.rizhuLabel') }} · {{ displayNameB }}</div>
            <div class="bzr-core-value">{{ chartB.riZhu }}</div>
            <div class="bzr-core-sub">{{ chartB.riZhuStrength }}</div>
          </div>
          <div class="bzr-card bzr-core">
            <div class="bzr-core-label">{{ $t('baziHunpan.report.strengthGaugeLabel') }}</div>
            <div class="bzr-gauge">
              <div class="bzr-gauge-track">
                ...
                <span class="bzr-gauge-pointer bzr-gauge-pointer-a" :style="{ left: gaugePosA + '%' }" />
                <span class="bzr-gauge-pointer bzr-gauge-pointer-b" :style="{ left: gaugePosB + '%' }" />
              </div>
              <div class="bzr-gauge-marks">
                <span>{{ $t('baziHunpan.report.weakLabel') }}</span>
                <span>{{ $t('baziHunpan.report.strongLabel') }}</span>
              </div>
              <div class="bzr-gauge-legend">
                <span><i class="bzr-legend-swatch bzr-legend-a" />{{ displayNameA }}</span>
                <span><i class="bzr-legend-swatch bzr-legend-b" />{{ displayNameB }}</span>
              </div>
            </div>
          </div>
          <div class="bzr-card bzr-core">
            <div class="bzr-core-label">{{ $t('baziHunpan.report.currentDayunLabel') }} · {{ displayNameA }}</div>
            <div class="bzr-core-value bzr-core-value-sm">{{ dayunTextA }}</div>
          </div>
          <div class="bzr-card bzr-core">
            <div class="bzr-core-label">{{ $t('baziHunpan.report.currentDayunLabel') }} · {{ displayNameB }}</div>
            <div class="bzr-core-value bzr-core-value-sm">{{ dayunTextB }}</div>
          </div>
        </div>
      </section>
      ...
      <section class="bzr-row bzr-pans">
        <div class="bzr-card bzr-pan">
          <h3 class="bzr-pan-title">{{ $t('baziHunpan.report.panTitle', { name: displayNameA }) }}</h3>
          <div class="bzr-bazi">
            ...
            <div class="bzr-dayun">
              <div class="bzr-dayun-title">{{ $t('baziHunpan.report.dayunTitle', { age: chartA.qiyunAge }) }}</div>
        ...
        <div class="bzr-card bzr-pan">
          <h3 class="bzr-pan-title">{{ $t('baziHunpan.report.panTitle', { name: displayNameB }) }}</h3>
          <div class="bzr-bazi">
            <div class="bzr-bazi-grid">
            ...
            <div class="bzr-dayun">
              <div class="bzr-dayun-title">{{ $t('baziHunpan.report.dayunTitle', { age: chartB.qiyunAge }) }}</div>
              <div class="bzr-dayun-row">
                <div
      ...
      <section class="bzr-row bzr-ai-row">
        <div class="bzr-card bzr-ai">
          <h3 class="bzr-ai-title"><span class="bzr-ai-no">01</span>{{ $t('baziHunpan.report.secDayPillar') }}</h3>
          <div class="bzr-ai-body bzr-md" v-html="renderSection(findSection('日柱配对'))" />
        </div>
        <div class="bzr-card bzr-ai">
          <h3 class="bzr-ai-title"><span class="bzr-ai-no">02</span>{{ $t('baziHunpan.report.secWuxing') }}</h3>
          <div class="bzr-ai-body bzr-md" v-html="renderSection(findSection('五行互补'))" />
        </div>
      </section>
      ...
      <section class="bzr-row bzr-ai-row">
        <div class="bzr-card bzr-ai">
          <h3 class="bzr-ai-title"><span class="bzr-ai-no">03</span>{{ $t('baziHunpan.report.secShishen') }}</h3>
          <div class="bzr-ai-body bzr-md" v-html="renderSection(findSection('十神关系'))" />
        </div>
        <div class="bzr-card bzr-ai">
          <h3 class="bzr-ai-title"><span class="bzr-ai-no">04</span>{{ $t('baziHunpan.report.secPersonality') }}</h3>
          <div class="bzr-ai-body bzr-md" v-html="renderSection(findSection('性格匹配'))" />
        </div>
      </section>
      ...
      <section class="bzr-section">
        <div class="bzr-card bzr-ai">
          <h3 class="bzr-ai-title"><span class="bzr-ai-no">05</span>{{ $t('baziHunpan.report.secDayun') }}</h3>
          <div class="bzr-ai-body bzr-md" v-html="renderSection(findSection('大运同步'))" />
        </div>
      </section>
      ...
      <section class="bzr-section">
        <div class="bzr-card bzr-ai">
          <h3 class="bzr-ai-title"><span class="bzr-ai-no">06</span>{{ $t('baziHunpan.report.secAdvice') }}</h3>
          ...
          <div v-else class="bzr-ai-body bzr-md" v-html="renderSection(findSection('合婚建议'))" />
        </div>
      </section>
      ...
      <div v-if="streaming" class="bzr-streaming">
        ...
        {{ $t('baziHunpan.report.streamingHint') }}
      </div>

      <!-- AI 错误 -->
      <div v-if="error" class="bzr-error">
        <p>{{ error }}</p>
        <button type="button" class="bzr-retry" @click="$emit('retry')">{{ $t('baziHunpan.reinterpret') }}</button>
      </div>

      <!-- ============ 页脚 ============ -->
      <footer class="bzr-foot">
        <span class="bzr-foot-note">ⓘ {{ $t('baziHunpan.report.footerNote') }}</span>
        <span class="bzr-seal bzr-seal-foot">{{ $t('baziHunpan.report.sealFoot') }}</span>
      </footer>
    </div>
  </div>
</template>
...
const displayNameA = computed(() => props.nameA || t('baziHunpan.personA'))
const displayNameB = computed(() => props.nameB || t('baziHunpan.personB'))

const genderTextA = computed(() =>
  props.genderA === 'male' ? t('baziHunpan.report.genderMale') : t('baziHunpan.report.genderFemale'))
const genderTextB = computed(() =>
  props.genderB === 'male' ? t('baziHunpan.report.genderMale') : t('baziHunpan.report.genderFemale'))

const metaLineA = computed(() => t('baziHunpan.report.metaLine', {
  label: displayNameA.value,
  riZhu: props.chartA.riZhu,
  strength: props.chartA.riZhuStrength,
  geju: props.chartA.geju,
}))
const metaLineB = computed(() => t('baziHunpan.report.metaLine', {
  label: displayNameB.value,
  riZhu: props.chartB.riZhu,
  strength: props.chartB.riZhuStrength,
  geju: props.chartB.geju,
}))

const dayunTextA = computed(() =>
  props.chartA.currentDaYun
    ? `${props.chartA.currentDaYun.gan}${props.chartA.currentDaYun.zhi}（${props.chartA.currentDaYun.ageRange[0]}-${props.chartA.currentDaYun.ageRange[1]}）`
    : t('baziHunpan.report.noDayun'))
const dayunTextB = computed(() =>
  props.chartB.currentDaYun
    ? `${props.chartB.currentDaYun.gan}${props.chartB.currentDaYun.zhi}（${props.chartB.currentDaYun.ageRange[0]}-${props.chartB.currentDaYun.ageRange[1]}）`
    : t('baziHunpan.report.noDayun'))
...
function gaugePosOf(strength: string): number {
  const map: Record<string, number> = { 从弱: 8, 身弱: 32, 身旺: 68, 从强: 92 }
  return map[strength] ?? 50
}
const gaugePosA = computed(() => gaugePosOf(props.chartA.riZhuStrength))
const gaugePosB = computed(() => gaugePosOf(props.chartB.riZhuStrength))

/* ---------- 四柱 ---------- */

function buildPillars(c: BaziChart) {
  const mk = (label: string, p: typeof c.year | null, isDay = false) => ({
    label,
    gan: p?.gan ?? '—',
    zhi: p?.zhi ?? '—',
    shishen: isDay ? t('baziHunpan.report.rizhuTag') : (p?.shishen ?? '—'),
    canggan: p?.canggan ?? [],
    isDay,
  })
  return [
    mk(t('baziHunpan.report.yearPillar'), c.year),
    mk(t('baziHunpan.report.monthPillar'), c.month),
    mk(t('baziHunpan.report.dayPillar'), c.day, true),
    mk(t('baziHunpan.report.hourPillar'), c.hour),
  ]
}
...
const pendingText = computed(() => t('baziHunpan.report.pending'))
...
const POS_WORDS = ['相合', '相生', '互补', '契合', '稳固', '和谐', '助', '吉', '佳', '旺', '缘深', '同步', '相配']
const NEG_WORDS = ['相冲', '相克', '相刑', '相害', '摩擦', '冲突', '不利', '阻碍', '分歧', '缘浅', '不同步', '克']
...
const MATCH_DIMS = [
  { key: 'day', keyword: '日柱配对', base: 70, color: '#8c2f26' },
  { key: 'wuxing', keyword: '五行互补', base: 68, color: '#a8512e' },
  { key: 'shishen', keyword: '十神关系', base: 66, color: '#8c6d1f' },
  { key: 'personality', keyword: '性格匹配', base: 68, color: '#4a7c59' },
  { key: 'dayun', keyword: '大运同步', base: 64, color: '#4a6a8a' },
] as const

const matchDims = computed(() =>
  MATCH_DIMS.map(d => ({
    key: d.key,
    label: t(`baziHunpan.report.dim_${d.key}`),
...
const matchLevel = computed(() => {
  const s = matchScore.value
  if (s >= 80) return t('baziHunpan.report.matchExcellent')
  if (s >= 65) return t('baziHunpan.report.matchGood')
  if (s >= 50) return t('baziHunpan.report.matchFair')
  return t('baziHunpan.report.matchWork')
})
...
const verdict = computed(() => {
  ...
  if (/相冲|相克|相刑|缘浅|不利|提防/.test(c)) return t('baziHunpan.report.verdictFriction')
  if (/互补|相合|相生|缘深|契合|同步|稳固/.test(c)) return t('baziHunpan.report.verdictMatch')
  return t('baziHunpan.report.verdictBalanced')
})

const titleText = computed(() => t('baziHunpan.report.title', {
...
const subtitleText = computed(() => {
  ...
  return first && first !== pendingText.value
    ? first.slice(0, 46)
    : t('baziHunpan.report.subtitleFallback')
})

/** 合婚建议：拆分为编号列表 */
const adviceList = computed(() => {
  const content = findSection('合婚建议') ?? ''
  if (!content) return []
  return content
    .split('\n')
...
/* ---------- 核心数据五卡 ---------- */
.bzr-core-grid { display: grid; grid-template-columns: 0.8fr 0.8fr 1.6fr 1.1fr 1.1fr; gap: 10px; }
...
.bzr-core-value-sm { font-size: 15px; letter-spacing: 1px; }
...
.bzr-gauge-pointer-a { background: var(--bzr-accent); }
.bzr-gauge-pointer-b { background: var(--bzr-blue); height: 8px; top: 0; }
.bzr-gauge-marks { display: flex; justify-content: space-between; font-size: 9px; color: var(--bzr-ink-faint); margin-top: 3px; }
.bzr-gauge-legend { display: flex; justify-content: center; gap: 14px; margin-top: 4px; font-size: 9px; color: var(--bzr-ink-faint); }
.bzr-gauge-legend span { display: inline-flex; align-items: center; gap: 3px; }
...
.bzr-pan, .bzr-ai, .bzr-bazi, .bzr-bazi-grid, .bzr-dayun, .bzr-wuxing-card, .bzr-match-grid { min-width: 0; }
