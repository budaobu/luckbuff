      ...
      innerHTML: JSON.stringify({
        ...
        mainEntity: {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: t('ziweiShiyeHepan.title'), url: 'https://www.ososn.com/tools/ziwei-shiye-hepan' },
            { '@type': 'ListItem', position: 3, name: t('home.toolBaziHunpanTitle'), url: 'https://www.ososn.com/tools/bazi-hunpan' },
            { '@type': 'ListItem', position: 4, name: t('ziweiHunpan.title'), url: 'https://www.ososn.com/tools/ziwei-hunpan' },
            { '@type': 'ListItem', position: 5, name: t('home.toolShengxiaoPeiduiTitle'), url: 'https://www.ososn.com/tools/shengxiao-peidui' },
          ],
        },
      }),
    },
